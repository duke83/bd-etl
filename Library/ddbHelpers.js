...
function getGlossaryItemByVarName(varname, val) {
...
exports.getGlossaryItemByVarName = getGlossaryItemByVarName;
function getFdicDdbTableName(YYYYMMDD, aon) {
    if (aon == 'alpha') {
...
exports.getFdicDdbTableName = getFdicDdbTableName;
...
exports.getAwsDynamodb = getAwsDynamodb;
function getAwsDynamodbDocClient(env) {
...
exports.getAwsDynamodbDocClient = getAwsDynamodbDocClient;
function getQDateFromFilename(filename) {
    //All_Reports_19921231_Unused Commitments.csv
    return filename.substr(12, 8);
}
exports.getQDateFromFilename = getQDateFromFilename;
//# sourceMappingURL=ddbHelpers.js.map